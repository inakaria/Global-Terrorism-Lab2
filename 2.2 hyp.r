...
df_group_1 <- data %>% filter(AttackType=="Armed Assault", !is.na(Killed))
df_group_2 <- data %>% filter(AttackType=="Bombing/Explosion", !is.na(Killed))
test_3_result <- perform_t_test(df_group_1, df_group_2)

cat("-- T-test Results --\n")
cat("mean_killed_armed: ", test_3_result$mean_killed_first_group, "\n")
cat("mean_killed_bombing: ", test_3_result$mean_killed_second_group, "\n")
...
cat("\n-- Wald Test Results --\n")
cat("mean_killed_armed: ", wald_3_result$mean_killed_first_group, "\n")
cat("mean_killed_bombing: ", wald_3_result$mean_killed_second_group, "\n")
