...
cat("-- T-test Results --\n")
cat("mean_killed_first_group: ", test_3_result$mean_killed_first_group, "\n")
cat("mean_killed_second_group: ", test_3_result$mean_killed_second_group, "\n")
...
cat("\n-- Wald Test Results --\n")
cat("mean_killed_first_group: ", wald_3_result$mean_killed_first_group, "\n")
cat("mean_killed_second_group: ", wald_3_result$mean_killed_second_group, "\n")
